...
import { logoUploader }   from "./components/settings/LogoUploader.js";
...
import { auditLogForm }      from "./components/security/AuditLogForm.js";
...
Alpine.data( "logoUploader", logoUploader );
...
Alpine.data( "auditLogForm", auditLogForm );
